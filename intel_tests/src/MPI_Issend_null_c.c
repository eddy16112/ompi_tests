...
-----------------------------------------------------------------------------*/
/******************************************************************************
		  Test for MPI_Issend() to MPI_PROC_NULL

This tests the basic blocking MPI_Issend operation to MPI_PROC_NULL.  No
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname, "MPI_Issend_null: all Issend to MPI_PROC_NULL");
