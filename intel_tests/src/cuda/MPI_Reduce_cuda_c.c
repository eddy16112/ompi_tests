                        ...
                        for (root = 0; root < test_nump; root++) {
                            if (has_op(op_count, test_type)
                                ...
                                if (MPITEST_current_rank == 0) {
                                    sprintf(info_buf,
                                            "length %d commsize %d commtype %d data_type %d root %d op %d",
                                ...
                                if (MPITEST_default_ops[op_count] ==
                                    MPI_PROD) {
                                ...
                                loop_cnt++;
                                ierr = MPI_Reduce((void *)gpu_send_buffer, (void *)gpu_recv_buffer,
                                                  length,
