...
-----------------------------------------------------------------------------*/
/******************************************************************************
       Test for Persistent  MPI_Ssend() to MPI_PROC_NULL

This tests the Persistent  MPI_Issend operation to MPI_PROC_NULL.  No
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname,
            "MPI_Ssend_init_null: Persistent all Ssend_init to MPI_PROC_NULL");
