...
(in mpitest_cfg.h) using MPI_Type_indexed() using length as blklen value.
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname, "MPI_Type_indexed_blklen");
...
/****************************************************************************/
                ...
                if (ierr != MPI_SUCCESS) {
                    fail++;
                    sprintf(info_buf, "MPI_Type_hindexed() returned %d",
                            ierr);
                    MPITEST_message(MPITEST_NONFATAL, info_buf);
                    MPI_Error_string(ierr, &info_buf[0], &size);
                    MPITEST_message(MPITEST_FATAL, info_buf);
