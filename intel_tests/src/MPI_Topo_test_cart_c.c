...
int main(int argc, char *argv[])
{
   ...
   /*------------------------------  MPI_Init  -----------------------------*/
    ...
    sprintf(testname, "MPI_Topo_test_cart: for Cartesian communicator");
 ...
 /*-------------------------  MPI_Topo_test  -----------------------*/
                ...
                ierr = MPI_Topo_test(comm_cart, &comm_top);
                ...
                if (comm_top != MPI_CART) {
                    sprintf(info_buf,
                            "Error in Topology type:  Actual = %d, Expected MPI_CART(%d)",
                            comm_top, MPI_CART);
                    MPITEST_message(MPITEST_FATAL, info_buf);
                }
