...
-----------------------------------------------------------------------------*/
/******************************************************************************
		  Test for MPI_Bsend() to MPI_PROC_NULL

This tests the basic blocking MPI_Bsend operation to MPI_PROC_NULL.  No
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname, "MPI_Bsend_null: all Bsend to MPI_PROC_NULL");
