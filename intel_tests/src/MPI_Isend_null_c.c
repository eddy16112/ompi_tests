...
-----------------------------------------------------------------------------*/
/******************************************************************************
		  Test for MPI_Isend() to MPI_PROC_NULL

This tests the nonblocking(asynchronous)  MPI_Isend operation to MPI_PROC_NULL.
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname, "MPI_Isend_null: all Isend to MPI_PROC_NULL");
