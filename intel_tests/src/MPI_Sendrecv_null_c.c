...
-----------------------------------------------------------------------------*/
/******************************************************************************
		  Test for MPI_Sendrecv() from MPI_PROC_NULL

This tests the MPI_Sendrecv operation from MPI_PROC_NULL.  No
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname,
            "MPI_Sendrecv_null: all Sendrecv from MPI_PROC_NULL");
