...
double runtest(int length, int count, MPI_Comm comm)
{
    ...
    MPI_Recv_init(bufp1, length, MPI_BYTE, MPI_ANY_SOURCE, 0, comm, &rreq);
    MPI_Rsend_init(bufp2, length, MPI_BYTE, next, 0, comm, &sreq);
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname, "MPI_Rsend_init_perf");
