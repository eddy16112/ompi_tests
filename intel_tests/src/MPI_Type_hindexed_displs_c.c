...
(in mpitest_cfg.h) using MPI_Type_hindexed() using length as displacement value.
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname, "MPI_Type_hindexed_displs");
...
/*********** This code was added by Debbie Swider 9/17/97 ****************/
                ...
                possible_size = (long long)length * (long long)(length - 1) * (long long)extent;
