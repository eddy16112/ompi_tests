...
#ifndef MPITEST_CFG_H_INCLUDED
#define MPITEST_CFG_H_INCLUDED
...
#ifdef LARGE_CLUSTER
/* Scale things back so we can run on large clusters */
...
MPITEST_unsigned, MPITEST_unsigned_long, MPITEST_float, MPITEST_double, 
MPITEST_char, MPITEST_unsigned_char, MPITEST_long_double, MPITEST_byte,
MPITEST_derived1,MPITEST_END_TOKEN
};
#endif
