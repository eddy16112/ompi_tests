...
-----------------------------------------------------------------------------*/
/******************************************************************************
       Test for Persistent  MPI_Send_init() to MPI_PROC_NULL

This tests the persistent  MPI_Send_init operation to MPI_PROC_NULL.
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname,
            "MPI_Isend_init_null: Persistent all nodes send to MPI_PROC_NULL");
