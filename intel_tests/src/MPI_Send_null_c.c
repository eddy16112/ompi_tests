...
-----------------------------------------------------------------------------*/
/******************************************************************************
		  Test for MPI_Send() to MPI_PROC_NULL

This tests the basic blocking MPI_Send operation to MPI_PROC_NULL.  No
...
int main(int argc, char *argv[])
{
    ...
    sprintf(testname, "MPI_Send_null: all Send to MPI_PROC_NULL");
